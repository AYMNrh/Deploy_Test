// data/projects.ts
import { FaReact, FaNodeJs, FaPython, FaDatabase, FaLinkedin, FaSyncAlt, FaHourglassEnd} from 'react-icons/fa';
...
export const projects: Project[] = [
  {
    id: 0,
    title: "Coming Soon",
    description: "Projects will be displayed here soon. Stay tuned!",
    icon: FaHourglassEnd,
    technologies: [],
    githubLink: "",
    skills: []
